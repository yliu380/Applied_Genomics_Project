...
OUTPUT_SAM="bowtie2/aligned_reads_${READS_FILENAME}.sam"
ALIGNMENT_SUMMARY="bowtie2/alignment_summary_${READS_FILENAME}.txt"

# Align reads to the reference genome using BOWTIE2
echo "Aligning reads to the reference genome..."
{ time $BOWTIE2_PATH -x bowtie2/reference_index -U $READS -S $OUTPUT_SAM 2>&1 ; } | tee -a $ALIGNMENT_SUMMARY
