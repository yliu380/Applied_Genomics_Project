...
OUTPUT_SAM="bowtie2/aligned_reads.sam"
ALIGNMENT_SUMMARY="bowtie2/alignment_summary.txt"

# Align reads to the reference genome using BOWTIE2
echo "Aligning reads to the reference genome..."
mkdir -p bowtie2
{ time $BOWTIE2_PATH -x "/data/mschatz1/xren15/bowtie2/${REFERENCE_NAME}/reference_index" -1 $READS1 -2 $READS2 -S $OUTPUT_SAM 2>&1 ; } | tee -a $ALIGNMENT_SUMMARY
